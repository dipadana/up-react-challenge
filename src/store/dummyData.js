export const dummyData = {
  ...
  stepsData: [
    {number: 1, step: "Heat sesame oil in a large skillet or wok over medium heat.", ingredients: Array(1), equipment: Array(2)},
    {number: 2, step: "Add ginger and garlic; cook for 30 seconds, or until fragrant, stirring constantly.", ingredients: Array(2), equipment: Array(0)},
    {number: 3, step: "Add kale and stir until coated with oil. Stir in s…seeds and red pepper flakes (if using) and serve.", ingredients: Array(4), equipment: Array(0)}
  ],
  ingredientsData: [
    {
